...
# ACCESS_TOKEN: Your GitHub personal access token with the following permissions:
#   - Account permissions: read:Followers, read:Starring, read:Watching
#   - Repository permissions: read:Commit statuses, read:Contents, read:Issues, read:Metadata, read:Pull Requests
# USER_NAME: Your GitHub username

# The script will use these environment variables
HEADERS = {'authorization': 'token '+ os.environ['ACCESS_TOKEN']}
USER_NAME = os.environ['USER_NAME']

# Counter for GitHub GraphQL API calls
...
if __name__ == '__main__':
    ...
    # Update this date with your birthday
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2000, 1, 1))  # Replace with your birthday
